const Subscribe = () => {
  return (
    <>
      <div className="absolute top-20 left-[50%] transform -translate-x-1/2 z-10 w-full container">
        <div className="border-2 border-white rounded-3xl p-6">
          <div className="font-sora relative w-full rounded-2xl px-5 text-center overflow-hidden bg-white container border border-[#1313131a] mx-auto flex flex-col items-center lg:py-20 py-12">
            {/* Soft blur effects */}
